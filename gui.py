#!/usr/bin/env python3
"""aboba-free GUI — visual updater for aboba."""
...
class PatcherGUI:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("aboba-free")
        self.root.geometry("500x400")
        self.root.resizable(False, False)

        # Header
        ttk.Label(self.root, text="aboba-free", font=("Arial", 16, "bold")).pack(pady=10)
        ttk.Label(self.root, text="Aboba Configuration Tool").pack()
